...
<div class="row">
    <div class="col-lg-4 mx-auto">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control <?php if ($validation->hasError('email')) echo 'is-invalid' ?>"
...
<div class="form-group">
    ...
    <input type="password" class="form-control <?php if($validation->hasError('password')) echo 'is-invalid' ?>"
